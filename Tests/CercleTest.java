...
class CercleTest {
    ...
    void getRayon() {
        ...
        assertTrue(c3.getRayon() == FormesGeometriques.DIM_MIN);
        assertTrue(c4.getRayon() == 6);
        assertTrue(c5.getRayon() == FormesGeometriques.DIM_MAX);
    ...
    void setRayon() {
        ...
        assertTrue(c1.getRayon() == FormesGeometriques.DIM_MIN);
        c1.setRayon(Carree.DIM_MIN);
        assertTrue(c1.getRayon() == FormesGeometriques.DIM_MIN);
        c1.setRayon(7);
        assertTrue(c1.getRayon() == 7);
        c1.setRayon(Carree.DIM_MAX + 1);
        assertTrue(c1.getRayon() == FormesGeometriques.DIM_MAX);
    }


    @Test
    void validerRayon() {
        assertFalse(Cercle.validerRayon(FormesGeometriques.DIM_MIN-1));
        assertTrue(Cercle.validerRayon(FormesGeometriques.DIM_MIN));
        assertTrue(Cercle.validerRayon(9));
        assertFalse(Cercle.validerRayon(FormesGeometriques.DIM_MAX+1));
        assertTrue(Cercle.validerRayon(FormesGeometriques.DIM_MAX));
    }
